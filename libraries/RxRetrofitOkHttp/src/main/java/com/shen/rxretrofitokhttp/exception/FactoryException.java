...
public class FactoryException {
    ...
    public static ApiException analysisExcetpion(Throwable e) {
        ...
        } else if (e instanceof HttpTimeException) {                                        // 自定义运行时异常
        ...
        } else if ( e instanceof JSONException || e instanceof ParseException) {            // fastjeson解析失败
